  ...
  render() {
    return (
      <React.Fragment>
        <div className='row mt-4'>
          <div className='col-12'>
            <label htmlFor='inp-root' className='inp'>
              <input value={this.state.registerChannelRoot}
                onChange={e => this.setState({ registerChannelRoot: e.target.value })}
                type='text'
                id='inp-root'
                placeholder='&nbsp;' />
            ...
            <div className='row mt-3'>
              <div className='col-12'>
                <label htmlFor='inp-address' className='inp'>
                  <input value={this.state.registerChannelSidekey}
                    onChange={e => this.setState({ registerChannelSidekey: e.target.value })}
                    type='text'
                    id='inp-sideKey'
                    placeholder='&nbsp;'
                  />
        ...
        <div className={'row ' + (!this.state.success && !this.state.error ? 'mt-4' : '')}>
