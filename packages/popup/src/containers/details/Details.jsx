  ...
  render() {
    return (
      <div>
        ...
        <div className="row mt-1">
          <div className="col-6">
            <button onClick={() => this.props.replayBundle(this.props.details[0].hash)} 
              disabled={this.props.details[0].persistence ? true : false} 
              className="btn btn-border-blue text-xs btn-small">
                Reattach <span className="fa fa-link"></span>
            </button>
          </div>
          <div className="col-6">
            <button onClick={() => this.props.promoteTransaction(this.props.details[0].hash)} 
              disabled={this.props.details[0].persistence ? true : false} 
              className="btn btn-border-blue text-xs btn-small">
